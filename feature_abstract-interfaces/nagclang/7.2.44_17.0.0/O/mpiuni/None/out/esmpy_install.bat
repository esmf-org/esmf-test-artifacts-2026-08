...
cd /Users/theurich/ESMF-Nightly-Testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_abstract-interfaces/esmf
...
python3 -m pip install . 2>&1| tee /Users/theurich/ESMF-Nightly-Testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_abstract-interfaces/esmpy-install.log
make download 2>&1| tee /Users/theurich/ESMF-Nightly-Testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_abstract-interfaces/esmpy-download.log
deactivate
conda deactivate
