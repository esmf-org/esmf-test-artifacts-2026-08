...
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='feature/refresh-bmauer-c_dynmask_interface+gbebbdcf2d2' -DESMF_MPIUNI -I/usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_refresh-bmauer-c_dynmask_interface/esmf/src/Infrastructure/stubs/mpiuni -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_PIO=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Darwin=1 -DESMF_COMM=mpiuni -DESMF_DIR=/usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_refresh-bmauer-c_dynmask_interface/esmf -D__SDIR__='' -DESMF_CXXSTD=11
...
ESMF_CCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='feature/refresh-bmauer-c_dynmask_interface+gbebbdcf2d2' -DESMF_MPIUNI -I/usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_refresh-bmauer-c_dynmask_interface/esmf/src/Infrastructure/stubs/mpiuni -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_PIO=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENMP -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Darwin=1 -DESMF_COMM=mpiuni -DESMF_DIR=/usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_mpiuni_O_feature_refresh-bmauer-c_dynmask_interface/esmf -D__SDIR__='' -DESMF_CSTD=99
