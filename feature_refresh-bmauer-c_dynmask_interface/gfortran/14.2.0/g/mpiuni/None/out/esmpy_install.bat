...
cd /usr/local/esmf/esmf-testing/gfortran_14.2.0_mpiuni_g_feature_refresh-bmauer-c_dynmask_interface/esmf
...
python3 -m pip install . 2>&1| tee /usr/local/esmf/esmf-testing/gfortran_14.2.0_mpiuni_g_feature_refresh-bmauer-c_dynmask_interface/esmpy-install.log
make download 2>&1| tee /usr/local/esmf/esmf-testing/gfortran_14.2.0_mpiuni_g_feature_refresh-bmauer-c_dynmask_interface/esmpy-download.log
deactivate
conda deactivate
