...
#SBATCH -o /gpfsm/dnb34/gtheuric/ESMF-Nightly-Testing/gfortran_14.2.0_openmpi_g_fix_cmake-config/test.bat_%j.o
#SBATCH -e /gpfsm/dnb34/gtheuric/ESMF-Nightly-Testing/gfortran_14.2.0_openmpi_g_fix_cmake-config/test.bat_%j.e
#SBATCH --time=2:00:00
...
module list >& /gpfsm/dnb34/gtheuric/ESMF-Nightly-Testing/gfortran_14.2.0_openmpi_g_fix_cmake-config/module-test.log
