...
module list >& /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_O_develop/module-test.log
...
/Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_O_develop/esmpy_install.bat
...
make test 2>&1| tee /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_O_develop/esmpy-test.log
deactivate
conda deactivate
