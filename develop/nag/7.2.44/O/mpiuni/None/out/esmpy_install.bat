...
cd /usr/local/esmf/esmf-testing/nag_7.2.44_mpiuni_O_develop/esmf
...
cd /usr/local/esmf/esmf-testing/nag_7.2.44_mpiuni_O_develop
...
cd /usr/local/esmf/esmf-testing/nag_7.2.44_mpiuni_O_develop/esmf/src/addon/esmpy
python3 -m pip install . 2>&1| tee /usr/local/esmf/esmf-testing/nag_7.2.44_mpiuni_O_develop/esmpy-install.log
make download 2>&1| tee /usr/local/esmf/esmf-testing/nag_7.2.44_mpiuni_O_develop/esmpy-download.log
deactivate
conda deactivate
