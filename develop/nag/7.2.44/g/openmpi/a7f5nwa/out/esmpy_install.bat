...
cd /usr/local/esmf/esmf-testing/nag_7.2.44_openmpi_g_develop/esmf
...
python3 -m pip install . 2>&1| tee /usr/local/esmf/esmf-testing/nag_7.2.44_openmpi_g_develop/esmpy-install.log
make download 2>&1| tee /usr/local/esmf/esmf-testing/nag_7.2.44_openmpi_g_develop/esmpy-download.log
deactivate
conda deactivate
