...
cd /glade/derecho/scratch/sacks/esmf-testing/intel_2024.2.1_mpi_g_develop/esmf
...
python3 -m pip install . 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/intel_2024.2.1_mpi_g_develop/esmpy-install.log
make download 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/intel_2024.2.1_mpi_g_develop/esmpy-download.log
deactivate
conda deactivate
