...
module list >& /usr/local/esmf/esmf-testing/gfortran_14.2.0_openmpi_g_develop/module-test.log
export WORK_ROOT=/usr/local/esmf/esmf-testing/gfortran_14.2.0_openmpi_g_develop
export TEMP_ROOT=/usr/local/esmf/esmf-testing/gfortran_14.2.0_openmpi_g_develop
cd $TEMP_ROOT/esmf
export ESMF_DIR=`pwd`
...
/usr/local/esmf/esmf-testing/gfortran_14.2.0_openmpi_g_develop/esmpy_install.bat
...
make test 2>&1| tee /usr/local/esmf/esmf-testing/gfortran_14.2.0_openmpi_g_develop/esmpy-test.log
deactivate
conda deactivate
