...
module list >& /usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_openmpi_g_develop/module-test.log
...
/usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_openmpi_g_develop/esmpy_install.bat
...
make test 2>&1| tee /usr/local/esmf/esmf-testing/nagclang_7.2.44_17.0.0_openmpi_g_develop/esmpy-test.log
deactivate
conda deactivate
