...
export ESMF_DIR=/Users/mathomp4/ESMF_Testing/llvm_22.1_openmpi_g_develop/esmf
export ESMF_COMPILER=llvm
export ESMF_COMM=openmpi
export ESMF_BOPT='g'
export ESMF_TESTEXHAUSTIVE='ON'
export ESMF_TESTWITHTHREADS='ON'
module list >& /Users/mathomp4/ESMF_Testing/llvm_22.1_openmpi_g_develop/module-build.log
export WORK_ROOT=/Users/mathomp4/ESMF_Testing/llvm_22.1_openmpi_g_develop
export TEMP_ROOT=/Users/mathomp4/ESMF_Testing/llvm_22.1_openmpi_g_develop
cd $TEMP_ROOT/esmf
export ESMF_DIR=`pwd`
set -o pipefail
