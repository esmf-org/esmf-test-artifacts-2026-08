...
cd /usr/local/esmf/esmf-testing/gfortranclang_14.2.0_17.0.0_openmpi_O_develop/esmf
...
cd /usr/local/esmf/esmf-testing/gfortranclang_14.2.0_17.0.0_openmpi_O_develop
...
cd /usr/local/esmf/esmf-testing/gfortranclang_14.2.0_17.0.0_openmpi_O_develop/esmf/src/addon/esmpy
python3 -m pip install . 2>&1| tee /usr/local/esmf/esmf-testing/gfortranclang_14.2.0_17.0.0_openmpi_O_develop/esmpy-install.log
make download 2>&1| tee /usr/local/esmf/esmf-testing/gfortranclang_14.2.0_17.0.0_openmpi_O_develop/esmpy-download.log
deactivate
conda deactivate
