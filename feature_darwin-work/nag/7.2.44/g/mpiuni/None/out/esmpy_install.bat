...
cd /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_g_feature_darwin-work/esmf
...
cd /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_g_feature_darwin-work
...
cd /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_g_feature_darwin-work/esmf/src/addon/esmpy
python3 -m pip install . 2>&1| tee /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_g_feature_darwin-work/esmpy-install.log
make download 2>&1| tee /Users/theurich/ESMF-Nightly-Testing/nag_7.2.44_mpiuni_g_feature_darwin-work/esmpy-download.log
deactivate
conda deactivate
